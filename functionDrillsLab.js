...
function nameCheck(reName){
  if (reName === "Steven"){
    console.log("What is up Steven?")
  } else if (reName === "Bryan"){
    console.log("Hey Bryan!")
  } else {
    console.log(`Cool name, ${reName}`)
  }
  }
...
function stringFunc(string1){
  console.log(string1.toUpperCase())
}
stringFunc(sampleString)
...
function frogStuff(gold){
let frogs = gold / 3
return frogs
}

totalFrogs = frogStuff(50)
...
function frogStuff2(gold){
  let frogs = gold / 3
  return Math.floor(frogs)
  }
  
  totalFrogs = frogStuff2(50)
  console.log(totalFrogs)
...
let arrayIsAscending = numArray(sampleArray)
